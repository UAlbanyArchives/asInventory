		...
		for sheet in wb.worksheets:
			...
			if checkSwitch == False:
				...
				for row in sheet.rows:
					...
					if lineCount > 6:
						try:
							date = helpers.iso2DACS(str(row[10].value))
						...
						try:
							date = helpers.iso2DACS(str(row[12].value))
						...
						try:
							date = helpers.iso2DACS(str(row[14].value))
						...
						try:
							date = helpers.iso2DACS(str(row[16].value))
						...
						try:
							date = helpers.iso2DACS(str(row[18].value))
